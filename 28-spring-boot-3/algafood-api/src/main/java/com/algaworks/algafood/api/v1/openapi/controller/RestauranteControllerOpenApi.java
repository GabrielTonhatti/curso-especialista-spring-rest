...
public interface RestauranteControllerOpenApi {
    ...
    void ativarMultiplos(@Parameter(description = "IDs de restaurantes", required = true) List<Long> restauranteIds);

    @Operation(summary = "Inativa múltiplos restaurante", responses = {
    ...
    void inativarMultiplos(@Parameter(description = "IDs de restaurantes", required = true) List<Long> restauranteIds);
