...
public class AuthorizationServerConfig {
    ...
    @Bean
    public ProviderSettings providerSettings(AlgaFoodSecutiryProperties properties) {
    ...
    public RegisteredClientRepository registeredClientRepository(PasswordEncoder passwordEncoder) {
        ...
        RegisteredClient algafoodweb = RegisteredClient
                ...
                .redirectUri("http://http://127.0.0.1:8080/swagger-ui/oauth2-redirect.html")
                .clientSettings(
                        ClientSettings
                                .builder()
    ...
    public JWKSource<SecurityContext> jwkSource(JwtKeyStoreProperties properties) throws Exception {
        ...
        Resource jwkLocation = properties.getJksLocation();
        InputStream inputStream = jwkLocation.getInputStream();
    ...
    public OAuth2TokenCustomizer<JwtEncodingContext> jwtCustomizer(UsuarioRepository usuarioRepository) {
        return context -> {
            ...
            if (authentication.getPrincipal() instanceof User) {
                ...
                context.getClaims().claim("id", usuario.getId().toString());
